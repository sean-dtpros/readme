...
1. Clone the repo
   ```sh
   git clone https://github.com/electroniquefleak/paragon-painting-rails-project.git
   ```
...
Project Link: [https://github.com/electroniquefleak/paragon-painting-rails-project/](https://github.com/electroniquefleak/paragon-painting-rails-project/)
